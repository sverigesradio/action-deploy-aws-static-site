...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const certificateArn = core.getInput("certificate_arn");
            const awsCredentials = {
                AWS_ACCESS_KEY_ID,
                AWS_SECRET_ACCESS_KEY,
                CDK_DEFAULT_REGION,
            };
            execCDK("bootstrap", Object.assign(Object.assign({}, awsCredentials), { CDK_DEPLOY_REGION: "eu-north-1", DOMAIN: domain, FOLDER: publish_dir, CERT_ARN: certificateArn }));
            execCDK("deploy --require-approval never", Object.assign(Object.assign({}, awsCredentials), { DOMAIN: domain, FOLDER: publish_dir, CERT_ARN: certificateArn }));
        }
        catch (error) {
